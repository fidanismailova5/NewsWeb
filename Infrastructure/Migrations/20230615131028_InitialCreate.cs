        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostLanguage_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostLanguage_User_PublisherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostLanguageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostHashtag_PostLanguage_PostLanguageId",
                        column: x => x.PostLanguageId,
                        principalTable: "PostLanguage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostHashtag_PostLanguageId",
                table: "PostHashtag",
                column: "PostLanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_PostLanguage_LanguageId",
                table: "PostLanguage",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLanguage_PublisherId",
                table: "PostLanguage",
                column: "PublisherId");
